...
namespace VetStat.Migrations
{
    ...
    [Migration("20260914170357_AddReviews")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VetStat.Models.AuthenticationToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VetStat.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VetStat.Models.Review", b =>
                {
                    b.HasOne("VetStat.Models.Appointment", "Appointment")
                        .WithMany()
            ...
            modelBuilder.Entity("VetStat.Models.Employee", b =>
                {
                    b.HasOne("VetStat.Models.Person", null)
                        .WithOne()
                        .HasForeignKey("VetStat.Models.Employee", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
